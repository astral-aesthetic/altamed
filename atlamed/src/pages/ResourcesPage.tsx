  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-600 via-blue-700 to-slate-900 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <h2 className="text-4xl font-bold mb-4 text-white">Looking for More Resources?</h2>
